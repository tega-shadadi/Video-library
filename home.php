...
<nav>
    ...
    <div class="nav-links" id="nav-links">
        ...
        <a href="logout.php" id="logout">ADMIN</a>
...
<section id="membership">
    ...
    <form action="save_member.php" method="POST">
        ...
        <input type="text" name="fullname" placeholder="example: John Doe" required>

        <label>Email</label>
        <input type="email" name="email" placeholder="example: john.doe@example.com" required>

        <label>Phone Number</label>
        <input type="text" name="phone" placeholder="example: +256 700 123 456">

        <label>Membership Type</label>
        <select name="membership">
            <option value="Standard">Standard - UGX 20,000/month</option>
            <option value="Premium">Premium - UGX 35,000/month</option>
        </select>
    ...
    <p style="color: green; text-align:center;">
        Registration successful! Welcome to SEMM Video Library 🎉
    </p>
    <?php endif; ?>
</section>
